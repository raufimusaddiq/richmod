...
export default function TransactionsPage() {
  ...
  async function createTransaction(event) {
    ...
    if (!values.accountId) delete values.accountId; if (!values.categoryId) delete values.categoryId; if (!values.note) delete values.note; if (!values.relatedWealthAccountId) delete values.relatedWealthAccountId; if (values.type !== "TRANSFER") delete values.purpose;
    try {
