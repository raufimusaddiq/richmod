...
func reviewActionsForType(kind string) []string {
	...
	case "WEALTH_OBSERVATION":
		return []string{"PREPARE_SNAPSHOT", "SET_WEALTH_ACCOUNT", "RECORD_ASSET_PURCHASE", "IGNORE"}
