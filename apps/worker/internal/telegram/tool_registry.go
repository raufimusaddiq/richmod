...
func NativeFinanceTools(categories []string, hasPendingAction, hasPendingBatch, hasActiveReview bool, reviewType string, flags ...bool) []gateway.ToolDefinition {
	...
	tools := []gateway.ToolDefinition{
		{Name: "record_transaction", Description: "Record one observed household IDR income or expense intent. For a clearly named purchased item or service, select the best matching allowed category. Go validates and persists.", Parameters: entry},
