...
func main() {
	...
	if err := run(context.Background(), email, name, householdName, os.Stdin); err != nil {
...
func run(ctx context.Context, email, name, householdName string, passwordInput *os.File) error {
