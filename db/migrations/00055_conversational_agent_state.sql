...
-- Parallel READ tools need refs that are collision-safe both inside a turn and
-- across bounded follow-up turns. Keep legacy tx_N / review_N and early Sprint 1
-- phase-scoped refs valid while accepting source-event-hash scoped refs such as
-- a1b2c3d4_p1r2_tx1. Canonical UUIDs remain server-private.
