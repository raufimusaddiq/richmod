...
1. Create R2 bucket `richmod-email-raw`, Queue `richmod-email-delivery`, and its dead-letter queue.
...
7. Inspect raw `.eml` authentication headers, then set `EMAIL_INGRESS_TRUSTED_AUTHSERV_IDS`. Do not infer this value.
